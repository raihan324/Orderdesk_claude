...
import { Users2, LogOut, UserCog } from "lucide-react";
      ...
      <header className="border-b border-slate-200 bg-white">
        <div className="mx-auto flex max-w-4xl items-center justify-between px-6 py-4">
          <div className="flex items-center gap-2">
            <div className="grid h-9 w-9 place-items-center rounded-lg bg-indigo-600 text-white"><Users2 size={18} /></div>
            <div>
              <p className="text-sm font-semibold tracking-tight">{affiliate.name}</p>
